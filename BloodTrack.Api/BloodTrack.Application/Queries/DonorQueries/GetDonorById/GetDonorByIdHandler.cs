...
{
    public class GetDonorByIdHandler : IRequestHandler<GetDonorByIdQuerie, ResultViewModel<GetDonorByIdViewModel>>
    {
        ...
        public async Task<ResultViewModel<GetDonorByIdViewModel>> Handle(GetDonorByIdQuerie request, CancellationToken cancellationToken)
        {
